    ...
    <div className="container mx-auto px-4 py-8">
        ...
        <TabsContent value="recommended">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Based on your curriculum and completed courses
              </CardDescription>
            </CardHeader>
            <CardContent>
        ...
        <TabsContent value="interests">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Electives that match your interests: {interests.join(", ")}
              </CardDescription>
            </CardHeader>
            <CardContent>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Track your progress through your curriculum
          </CardDescription>
        </CardHeader>
        <CardContent>
          <div className="flex justify-between items-center">
            <div>
              <h3 className="font-medium">
                Completed Courses: {studentData.completedCourses.length}
              </h3>
              <p className="text-sm text-muted-foreground">
                Remaining Required: {studentData.remainingRequired}
              </p>
            </div>
            <Button asChild>
